                        ...
                        <div className='element w-full h-[56px] flex flex-row items-center justify-between px-[5%]'>
                            <div className='flex flex-row items-center justify-between w-full'>
                                ...
                                <div className='w-[137px] h-[28px] rounded-[38px] bg-[#05F292] flex items-center justify-center flex-row gap-2'>
                                    ...
                                    <div >
                                        {
                                            copied === true ? <Image src={"/Images/check.svg"} width={11} height={12.22} alt="" /> :
                                                <Image onClick={handleCopy} src={"/Images/copy.svg"} width={11} height={12.22} alt="" />
                                        }
                        ...
                        <div className='element w-full h-[56px] flex flex-row items-center justify-between px-[5%]'>
                            <div className='flex flex-row items-center justify-between w-full'>
                                ...
                                <div className='w-[137px] h-[28px] rounded-[38px] bg-[#05F292] flex items-center justify-center flex-row gap-2'>
                                    ...
                                    <div >
                                        {
                                            copied2 === true ? <Image src={"/Images/check.svg"} width={11} height={12.22} alt="" /> :
                                                <Image onClick={handleCopy2} src={"/Images/copy.svg"} width={11} height={12.22} alt="" />
                                        }
                    ...
                    <div className='element w-full h-[56px] flex flex-row items-center justify-between px-[5%]'>
                        <div className='flex flex-col leading-none gap-1'>
                            ...
                            <div className='flex flex-row items-center gap-1'>
                                <Image src={"/Images/coin.svg"} width={13} height={13} alt="" />
                                <p className='font-bold text-[#05F292]'>350 Points</p>
                            </div>
                        </div>
                        <Image src={"/Images/Line.svg"} width={1} height={1} alt='' />
                    ...
                    <div className='element w-full h-[56px] flex flex-row items-center justify-between px-[5%]'>
                        <div className='flex flex-row items-center justify-between w-full'>
                            ...
                            <div className='w-[137px] h-[28px] rounded-[38px] bg-[#05F292] flex items-center justify-center flex-row gap-2'>
                                ...
                                <div >
                                    {
                                        copied3 === true ? <Image src={"/Images/check.svg"} width={11} height={12.22} alt="" /> :
                                            <Image onClick={handleCopy3} src={"/Images/copy.svg"} width={11} height={12.22} alt="" />
                                    }
