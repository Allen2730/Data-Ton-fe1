                ...
                <div>
                    ...
                    <div className='px-3 w-full mt-11 flex flex-col gap-4'>
                        <div className='flex flex-col gap-6 w-full'>
                            <p className='text-[18px] font-bold paytone text-white'>NO.12345678</p>
                            <p className='text-[#C3C3C3] w-[70%]'>Did:memo:d687daa192ffa26373395872191e <br /> 8502cc41fbfbf27dc07d3da3a3</p>
                        </div>
