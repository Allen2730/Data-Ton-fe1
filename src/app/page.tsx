...
export default function Home() {
  return (
    <div className="w-full h-screen flex justify-center items-center bg relative ">
      <Image src={"/Images/token.svg"} className="absolute top-0 left-0" width={149.58} height={204.3} alt="" />
      <Image src={"/Images/ellipse.svg"} className="absolute top-0 right-0" width={447} height={666} alt="" />
      <div className="flex flex-col gap-2 items-center z-[600]">
        <div className="flex flex-row items-center gap-2">
          <p className="text-white font-semibold">mini app</p>
          <Image src={"/Images/verified.svg"} width={11} height={11} alt="" />
        </div>
        ...
        <div className="mt-5">
          <Link href={"/create-did"} className="w-[155px] h-[42px] rounded-[37px] bg-[#05F292] py-[9px] px-[20px] flex items-center gap-2 z-[500]">
      ...
      <Image src={"/Images/m.svg"} className="absolute bottom-0 left-0" width={300.31} height={300.31} alt="" />
    </div>
  );
}
